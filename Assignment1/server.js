 ...
 *  - dotted
 *    - word1 or word2 missing
 *    - word1 and word2 total to more than 30 characters
 *  - numCheck
 *    - start or end missing
 *    - start or end is not a number
 *  - grading
 *    - at lest one grade value
 *    - a grade value is not a number
 *  - calculateRectangleProperties
 *    - length or width missing
 *    - length or width is not a number
 *    - lentrh or width is negative
 */
